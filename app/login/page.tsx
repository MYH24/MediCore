...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store session data in sessionStorage for client-side access
    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-b from-teal-50 to-white p-4">
      <Card className="w-full max-w-md shadow-xl border-0 bg-white/80 backdrop-blur">
        ...
        <CardFooter className="flex-col gap-4">
          <div className="w-full rounded-lg bg-teal-50 p-3 text-sm">
            <p className="font-medium text-teal-800 mb-2">Demo Credentials:</p>
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="mt-2 w-full border-teal-300 text-teal-700 hover:bg-teal-100"
              onClick={() => {
